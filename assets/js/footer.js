  ...
  function generateFooter({ logoUrl, links, phone, email, copyright, dir }) {
    return `
      ...
      <div class="footer-contact-row">
        ...
        <a href="https://www.linkedin.com/in/gal-shusha-a40549164/" target="_blank" aria-label="LinkedIn" class="footer-social-link"><i class="fab fa-linkedin"></i></a>
        </div>
      </div>
      ${logoUrl ? `
